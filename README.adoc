...
|`nvd-cache-primer/`
|Utility project for priming and validating the OWASP Dependency-Check NVD cache workflow.

|`examples/architecture-validator/single-module-spring/`
|Runnable example that demonstrates Spring Hexagonal rule-pack violations and failing architecture validation.
